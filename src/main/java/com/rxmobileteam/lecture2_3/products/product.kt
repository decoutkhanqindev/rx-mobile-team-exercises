...
fun Order.getMaxPriceProduct(): Product =
  this.products.maxByOrNull { it.price } ?: throw NoSuchElementException("No products in order")

// TODO: Return the product with the min price in the order
fun Order.getMinPriceProduct(): Product =
  this.products.minByOrNull { it.price } ?: throw NoSuchElementException("No products in order")
